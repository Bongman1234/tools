...
Function RestartScript{
    if($PSCommandPath.Length -gt 0){
        ...
        Start-Process PowerShell.exe -ArgumentList ("-NoP -Ep Bypass -C irm https://raw.githubusercontent.com/Bongman1234/tools/main/Misc/Global%20PS%20Logging.ps1 | iex") -Verb RunAs
    }
